...
const allowedOrigins = [
  ...
  'https://localhost:5173',            // Allow local development (adjust as needed)
  'https://fvvcbrpm-4000.inc1.devtunnels.ms', // Allow dev tunnel if needed
  'https://31.97.237.55', // Ensure you're using HTTPS for backend communication
];
...
// 4) Connect to DB (non-blocking). If connectDB returns a promise, you can .catch here.
try {
...
// Contact form route to send mail (improved)
...
// // (optional but nice) handle all preflights
